  ...
  return (
    <div className="min-h-screen bg-obsidian-950 selection:bg-crimson-500/30 font-sans relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="blur-blob w-[600px] h-[600px] bg-red-600/20 -top-[10%] -left-[5%]" />
        <div className="blur-blob w-[500px] h-[500px] bg-rose-600/10 bottom-[-10%] right-[-5%]" style={{ animationDelay: '2s' }} />
        <div className="blur-blob w-[400px] h-[400px] bg-crimson-500/10 top-[40%] right-[10%]" style={{ animationDelay: '4s' }} />
